...
const RevnueChart = () => {
  ...
  // Distribute total revenue across 12 months for chart purposes
  const months = [
    "Jan",
    "Feb",
    "Mar",
  ...
  const data = months.map((month) => ({
    month,
    revenue: Math.round(totalRevenue / 12),
    expenses: Math.round((totalRevenue / 12) * 0.6), // Example: 60% of revenue as expenses
  }));
