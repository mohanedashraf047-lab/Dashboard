          ...
          <table className="w-full">
            ...
            <tbody>
              {recentOrders.map((order) => {
                return (
                  <tr key={order.id} className="border-b border-slate-200/50 dark:border-slate700/50 hover:bg-slate-50/50 dark:hover:bg-slate-800/50 transition-colors">
                    <td className="p-4" >
          ...
          {topProducts.map((product) => {
            return (
              <div className="flex items-center justify-between p-4 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                <div className="flex-1" key={product.name}>
